package fotistsiou.javatutorial.fundamentals.h_methods.problems;

import java.util.Scanner;

/**
 * Calculation the fibonacci number of the input number with following ways and print the calculation time:
 * 1. Fibonacci Number Using Recursion
 * 2. Fibonacci Number Using Memoization
 */
